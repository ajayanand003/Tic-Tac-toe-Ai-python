...
class TIC_TAC_TOE_AI:
    def __init__(self, root):
        ...
        self.window = root
        self.make_canvas = Canvas(self.window, background="#00FFFF", relief=RAISED, bd=3)
    ...
    def decorating(self):# Basic Set-up
        Label(self.make_canvas, text="Tic-Tac-Toe AI", bg="#141414", fg="#00FF00", font=("Futura", 25, "bold")).place(x=110, y=10)
        self.btn_1 = Button(self.make_canvas, text="", font=("Helvetica", 15, "bold", "italic"), width=5, bg="#262626", activebackground="#262626", bd=3, command=lambda: self.__human_play(1), state=DISABLED)
    ...
    def control_give(self, indicator="human_first"):# Control give based on human first or computer first play
        self.machine_first_control.config(state=DISABLED, disabledforeground="black")
        self.human_first_control.config(state=DISABLED, disabledforeground="black")
        self.reset_btn.config(state=DISABLED, disabledforeground="black")
        for every in self.activate_btn:
